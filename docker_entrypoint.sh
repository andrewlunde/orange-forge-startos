...
# This is being done in orange-forge instead
...
#apk add nodejs=18.20.4
apk add nodejs 
apk add npm
apk add yarn

git clone https://github.com/andrewlunde/did-btc-forge.git

cd did-btc-forge

npm i --include prod --include dev 
